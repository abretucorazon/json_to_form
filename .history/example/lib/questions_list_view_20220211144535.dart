...
class QuestionsListView extends StatefulWidget {
 ...
 // Class method to extract arguments from route to create an instance of this class 
  static Widget navigateTo(BuildContext context) {
    ...
    final args  = (route != null) ? (route.settings.arguments as Map<String,dynamic>) : null;
    ...
    return 
      ...
      : errorScreen(context,'Cannot display questions - Schema for Questions is missing');
  }
...
class _QuestionsListView extends State<QuestionsListView> {
  ...
  Widget build(BuildContext context) {
    ...
    final route = ModalRoute.of(context);
    final routeArg = (route != null) ? (route.settings.arguments as Map<String,dynamic>) : null;
           ...
           DrawerHeader(
            ...
            ListTile(
              ...
              onTap: () {
                  ...
                  Navigator.pushNamed(context, '/textQuestion', arguments:FormFieldSchema.getInputMetaSchema()).
                  then((results) {
                      saveAction(results);
                  });
              },
...
*/
            ...
            ListTile(
              ...
              onTap: () {
                  Navigator.pop(context);
                  Navigator.pushNamed(context, '/previewQuestionaire', arguments: formSchema);
              },
            ),
                        ...
                        Card(
                          child:
                           ListTile(
                            ...
                            subtitle: Text((field['value'] != null) ? '${field['value']}' : '(empty)'),
                            )
                        )
                    )
                    .toList(),
