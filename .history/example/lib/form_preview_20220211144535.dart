...
class QuestionnairePreview extends StatefulWidget {
  final Map<String,dynamic> form;
  
  QuestionnairePreview(this.form,{Key key}) : super(key: key);

  @override
  _QuestionnairePreview createState() => new _QuestionnairePreview();
  ...
  static Widget navigateTo(BuildContext context) {
    ...
    return 
      (form != null) 
      ? QuestionnairePreview(form) 
      : errorScreen(context,'Preview failed - Schema for Questions is missing');
  }

}

class _QuestionnairePreview extends State<QuestionnairePreview> {
  dynamic response;
...
*/
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("Preview: " + ((widget.form['title'] != null) ? widget.form['title'] : '')), 
      ),
