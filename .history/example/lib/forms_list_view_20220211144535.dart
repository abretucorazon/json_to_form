...
// Class method to extract arguments from route to create an instance of this class 
  static Widget navigateTo(BuildContext context) {
    ...
    final args  = (route != null) ? (route.settings.arguments as List<Map<String,dynamic>>) : null;
    final forms = (args != null) ? args : testForms;
      ...
      if (fields != null) {
          fields.forEach(
            (Map<String,dynamic> fieldMetaData) {
              final key = fieldMetaData['name'] as String;
              final value = fieldMetaData['value'];
        ...
        actions: <Widget>[
         /* IconButton(
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.pushNamed(context,'/newForm',arguments: FormFieldSchema.getFormMetaSchema())
                .then((results) {
                      saveNewForm(results);
                  });
                ...
                Card(
                  child: 
                    ListTile(
                      ...
                      onTap: () {
                        Navigator.pushNamed(context, '/questionsList',arguments: field);
                      },
                    )
                )
            )
